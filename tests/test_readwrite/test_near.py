...
class TestFitsReadingModule(object):
    ...
    def test_fits_reading(self):
        ...
        read = NearInitializationModule(name_in="read1",
                                        inmage_in_dir=self.test_dir + "fits",
    ...
    def test_fits_reading_overwrite(self):
        ...
        read = NearInitializationModule(name_in="read2",
                                        inmage_in_dir=self.test_dir + "fits",
                                        image_out_tag_1="noda_chopa",
                                        image_out_tag_2="noda_chopb",
                                        image_out_tag_3="nodb_chopa",
    ...
    def test_static_changing(self):
        ...
        read = NearInitializationModule(name_in="read4",
                                        image_in_dir=self.test_dir + "fits",
                                        image_out_tag_1="noda_chopa",
                                        image_out_tag_2="noda_chopb",
                                        image_out_tag_3="nodb_chopa",
                                        image_out_tag_4="nodb_chopb",
    ...
    def test_header_attribute(self):
        ...
        read = NearInitializationModule(name_in="read5",
                                        image_in_dir=self.test_dir + "fits",
                                        image_out_tag_1="noda_chopa",
                                        image_out_tag_2="noda_chopb",
                                        image_out_tag_3="nodb_chopa",
    ...
    def test_non_static_not_found(self):
        ...
        read = NearInitializationModule(name_in="read6",
                                        image_in_dir=self.test_dir + "fits",
                                        image_out_tag_1="noda_chopa",
                                        image_out_tag_2="noda_chopb",
                                        image_out_tag_3="nodb_chopa",
