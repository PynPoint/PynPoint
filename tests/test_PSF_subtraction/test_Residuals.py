...
class TestResidual(object):
    ...
    def setup(self):
        ...
        self.basis = PynPoint.basis.create_wdir(self.test_data_dir, resize=-1, ran_sub=False, cent_size=0.2)
        self.images = PynPoint.images.create_wdir(self.test_data_dir, resize=-1, ran_sub=False, cent_size=0.2)
