...
class TestImages(object):
    ...
    def test_overall_images3(self):
        ...
        assert np.allclose(self.images3.im_arr.min(), -0.0020284527946860184, rtol=limit)
        assert np.allclose(self.images3.im_arr.max(), 0.010358342288026002, rtol=limit)
        assert np.allclose(self.images3.im_arr.var(), 6.742995184109506e-07, rtol=limit)
        ...
        assert np.allclose(self.images3.cent_mask.var(), 0.05578190564690256, rtol=limit)
    ...
    def test_mk_psfmodel(self):
        ...
        assert np.allclose(self.images3._psf_coeff.min(), -0.05665318776958124, rtol=limit)
        assert np.allclose(self.images3._psf_coeff.max(), 0.04385567279218046, rtol=limit)
        assert np.allclose(self.images3._psf_coeff.var(), 0.0007563868864071419, rtol=limit)
        assert self.images3.psf_im_arr.shape == (4, 146, 146)
        assert np.allclose(self.images3.psf_im_arr.mean(), 0.0004695346933652781, rtol=limit)
        assert np.allclose(self.images3.psf_im_arr.min(), -0.0020284527946860115, rtol=limit)
        assert np.allclose(self.images3.psf_im_arr.max(), 0.010358342288026004, rtol=limit)
        assert np.allclose(self.images3.psf_im_arr.var(), 6.742995184109506e-07, rtol=limit)
    ...
    def test_mk_psf_realisation(self):
        ...
        assert np.allclose(im_temp.mean(), 0.0004464003580538407, rtol=limit)
        assert np.allclose(im_temp.min(), -0.00159553949981, rtol=limit)
        assert np.allclose(im_temp.max(), 0.00827001007918308, rtol=limit)
        assert np.allclose(im_temp.var(), 6.434636488078924e-07, rtol=limit)
