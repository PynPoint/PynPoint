...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.coverage', 'sphinx.ext.mathjax', 'sphinx.ext.viewcode', 'sphinx.ext.intersphinx']
...
latex_documents = [
  ('index', 'PynPoint.tex', u'PynPoint Documentation',
   u'Adam Amara', 'manual'),
]
...
man_pages = [
    ('index', 'PynPoint', u'PynPoint Documentation',
     [u'Adam Amara'], 1)
]
...
texinfo_documents = [
  ('index', 'PynPoint', u'PynPoint Documentation',
   u'Adam Amara', 'PynPoint', 'One line description of project.',
   'Miscellaneous'),
]
