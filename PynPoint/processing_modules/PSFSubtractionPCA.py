...
class PSFSubtractionPCAmulit(ProcessingModule):
    ...
    def __init__(self,
        ...
        super(PSFSubtractionPCAmulit, self).__init__(name_in)
    ...
    def run(self):
        ...
        self.m_res_mean_out_port.add_history_information("PSF_subtraction", history)
        self.m_res_median_out_port.add_history_information("PSF_subtraction", history)
        self.m_res_rot_mean_clip_out_port.add_history_information("PSF_subtraction", history)
