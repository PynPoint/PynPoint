...
class ContrastCurveModule(ProcessingModule):
    ...
    def __init__(self,
        ...
        if "accuracy" in kwargs:
            warnings.warn("The 'accuracy' parameter has been deprecated.", DeprecationWarning)

        if "magnitude" in kwargs:
            warnings.warn("The 'magnitude' parameter has been deprecated.", DeprecationWarning)
